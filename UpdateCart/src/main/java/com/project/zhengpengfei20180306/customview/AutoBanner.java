package com.project.zhengpengfei20180306.customview;
...
public class AutoBanner extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.autobanner, this, true);
    ...
    private void drawDots() {
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                iv.setImageResource(R.drawable.shapeselect);
            } else {
                iv.setImageResource(R.drawable.shapenoselect);
            }
    ...
    public void onPageSelected(int position) {
        for (int i = 0; i < count; i++) {
            if (i == position) {
                mDotImageviews.get(i).setImageResource(R.drawable.shapeselect);
            } else {
                mDotImageviews.get(i).setImageResource(R.drawable.shapenoselect);
            }
        }
    }
